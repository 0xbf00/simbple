...
// Custom struct to save arbitrary data in cell structure.
typedef void (*blob_free_func)(void *, size_t);
typedef struct {
  size_t tag;
  void *blob;
  size_t size;
...
pointer mk_blob(scheme *sc, size_t tag, void *blob, size_t size,
                blob_free_func blob_free);
...
struct scheme_interface {
  ...
  int (*is_blob)(pointer p);
  blob_info_t (*blob_info)(pointer p);
