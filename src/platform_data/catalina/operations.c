...
static const char *syscall_unix_filters[] = {
    "system",
    "process",
    "syscall",
};
static const char *syscall_unix_modifiers[] = {
    "send-signal",
    "report",
    "no-report",
    "message",
...
static const operation_info_t operation_infos[] = {
    ...
    { // appleevent-send
        ...
        0, // -> default
        0,
        appleevent_send_filters,
        appleevent_send_modifiers
    },
    { // authorization-right-obtain
        NONTERMINAL_NODE,
        0, // -> default
        0,
        authorization_right_obtain_filters,
    ...
    { // boot-arg-set
        ...
        0, // -> default
        0,
        boot_arg_set_filters,
        boot_arg_set_modifiers
    },
    { // device*
        NONTERMINAL_NODE,
        0, // -> default
        0,
        device_all_filters,
        device_all_modifiers
    },
    { // device-camera
        NONTERMINAL_NODE,
        4, // -> device*
        0,
        device_camera_filters,
        device_camera_modifiers
    },
    { // device-microphone
        NONTERMINAL_NODE,
        4, // -> device*
        0,
        device_microphone_filters,
        device_microphone_modifiers
    },
    { // darwin-notification-post
        TERMINAL_NODE,
        0, // -> default
        1,
        darwin_notification_post_filters,
        darwin_notification_post_modifiers
    },
    { // distributed-notification-post
        NONTERMINAL_NODE,
        0, // -> default
        0,
        distributed_notification_post_filters,
    ...
    { // dynamic-code-generation
        ...
        0, // -> default
        1,
        dynamic_code_generation_filters,
        dynamic_code_generation_modifiers
    },
    { // file*
        NONTERMINAL_NODE,
        0, // -> default
    ...
    { // file-ioctl
        ...
        0,
        file_ioctl_filters,
        file_ioctl_modifiers
    },
    { // file-issue-extension
        NONTERMINAL_NODE,
        10, // -> file*
        0,
        file_issue_extension_filters,
        file_issue_extension_modifiers
    },
    { // file-link
        TERMINAL_NODE,
        0, // -> default
    ...
    { // file-map-executable
        ...
        0, // -> default
        1,
        file_map_executable_filters,
        file_map_executable_modifiers
    },
    { // file-mknod
        NONTERMINAL_NODE,
        10, // -> file*
    ...
    { // file-mount
        ...
        0,
        file_mount_filters,
        file_mount_modifiers
    },
    { // file-mount-update
        NONTERMINAL_NODE,
        18, // -> file-mount
        0,
        file_mount_update_filters,
        file_mount_update_modifiers
    },
    { // file-read*
        NONTERMINAL_NODE,
        10, // -> file*
        0,
        file_read_all_filters,
        file_read_all_modifiers
    },
    { // file-read-data
        NONTERMINAL_NODE,
        20, // -> file-read*
        0,
        file_read_data_filters,
        file_read_data_modifiers
    },
    { // file-read-metadata
        NONTERMINAL_NODE,
        20, // -> file-read*
        0,
        file_read_metadata_filters,
        file_read_metadata_modifiers
    },
    { // file-read-xattr
        NONTERMINAL_NODE,
        20, // -> file-read*
        0,
        file_read_xattr_filters,
        file_read_xattr_modifiers
    },
    { // file-revoke
        NONTERMINAL_NODE,
        10, // -> file*
    ...
    { // file-search
        ...
        0,
        file_search_filters,
        file_search_modifiers
    },
    { // file-test-existence
        TERMINAL_NODE,
        0, // -> default
        1,
        file_test_existence_filters,
        file_test_existence_modifiers
    },
    { // file-unmount
        NONTERMINAL_NODE,
        10, // -> file*
        0,
        file_unmount_filters,
        file_unmount_modifiers
    },
    { // file-write*
        NONTERMINAL_NODE,
        10, // -> file*
        0,
        file_write_all_filters,
        file_write_all_modifiers
    },
    { // file-write-acl
        NONTERMINAL_NODE,
        28, // -> file-write*
        0,
        file_write_acl_filters,
        file_write_acl_modifiers
    },
    { // file-write-create
        NONTERMINAL_NODE,
        28, // -> file-write*
        0,
        file_write_create_filters,
        file_write_create_modifiers
    },
    { // file-write-data
        NONTERMINAL_NODE,
        28, // -> file-write*
        0,
        file_write_data_filters,
        file_write_data_modifiers
    },
    { // file-write-finderinfo
        NONTERMINAL_NODE,
        28, // -> file-write*
        0,
        file_write_finderinfo_filters,
        file_write_finderinfo_modifiers
    },
    { // file-write-flags
        NONTERMINAL_NODE,
        28, // -> file-write*
        0,
        file_write_flags_filters,
        file_write_flags_modifiers
    },
    { // file-write-mode
        NONTERMINAL_NODE,
        28, // -> file-write*
        0,
        file_write_mode_filters,
        file_write_mode_modifiers
    },
    { // file-write-owner
        NONTERMINAL_NODE,
        28, // -> file-write*
        0,
        file_write_owner_filters,
        file_write_owner_modifiers
    },
    { // file-write-setugid
        TERMINAL_NODE,
        0, // -> default
        0,
        file_write_setugid_filters,
        file_write_setugid_modifiers
    },
    { // file-write-times
        NONTERMINAL_NODE,
        28, // -> file-write*
        0,
        file_write_times_filters,
        file_write_times_modifiers
    },
    { // file-write-unlink
        NONTERMINAL_NODE,
        28, // -> file-write*
        0,
        file_write_unlink_filters,
        file_write_unlink_modifiers
    },
    { // file-write-xattr
        NONTERMINAL_NODE,
        28, // -> file-write*
        0,
        file_write_xattr_filters,
        file_write_xattr_modifiers
    },
    { // fs-rename
        NONTERMINAL_NODE,
        0, // -> default
    ...
    { // fs-snapshot*
        ...
        0, // -> default
        0,
        fs_snapshot_all_filters,
        fs_snapshot_all_modifiers
    },
    { // fs-snapshot-create
        NONTERMINAL_NODE,
        41, // -> fs-snapshot*
        0,
        fs_snapshot_create_filters,
        fs_snapshot_create_modifiers
    },
    { // fs-snapshot-delete
        NONTERMINAL_NODE,
        41, // -> fs-snapshot*
        0,
        fs_snapshot_delete_filters,
        fs_snapshot_delete_modifiers
    },
    { // fs-snapshot-revert
        NONTERMINAL_NODE,
        41, // -> fs-snapshot*
        0,
        fs_snapshot_revert_filters,
        fs_snapshot_revert_modifiers
    },
    { // generic-issue-extension
        NONTERMINAL_NODE,
        0, // -> default
        0,
        generic_issue_extension_filters,
        generic_issue_extension_modifiers
    },
    { // qtn-user
        NONTERMINAL_NODE,
        0, // -> default
    ...
    { // iokit-issue-extension
        ...
        48, // -> iokit*
        0,
        iokit_issue_extension_filters,
        iokit_issue_extension_modifiers
    },
    { // iokit-open
        NONTERMINAL_NODE,
        48, // -> iokit*
        0,
        iokit_open_filters,
        iokit_open_modifiers
    },
    { // iokit-set-properties
        NONTERMINAL_NODE,
        48, // -> iokit*
        0,
        iokit_set_properties_filters,
        iokit_set_properties_modifiers
    },
    { // iokit-get-properties
        TERMINAL_NODE,
        0, // -> default
        1,
        iokit_get_properties_filters,
        iokit_get_properties_modifiers
    },
    { // ipc*
        NONTERMINAL_NODE,
        0, // -> default
    ...
    { // ipc-posix*
        ...
        53, // -> ipc*
        0,
        ipc_posix_all_filters,
        ipc_posix_all_modifiers
    },
    { // ipc-posix-issue-extension
        NONTERMINAL_NODE,
        54, // -> ipc-posix*
        0,
        ipc_posix_issue_extension_filters,
        ipc_posix_issue_extension_modifiers
    },
    { // ipc-posix-sem*
        NONTERMINAL_NODE,
        54, // -> ipc-posix*
        0,
        ipc_posix_sem_all_filters,
        ipc_posix_sem_all_modifiers
    },
    { // ipc-posix-sem-create
        NONTERMINAL_NODE,
        56, // -> ipc-posix-sem*
        0,
        ipc_posix_sem_create_filters,
        ipc_posix_sem_create_modifiers
    },
    { // ipc-posix-sem-open
        NONTERMINAL_NODE,
        56, // -> ipc-posix-sem*
        0,
        ipc_posix_sem_open_filters,
        ipc_posix_sem_open_modifiers
    },
    { // ipc-posix-sem-post
        NONTERMINAL_NODE,
        56, // -> ipc-posix-sem*
        0,
        ipc_posix_sem_post_filters,
        ipc_posix_sem_post_modifiers
    },
    { // ipc-posix-sem-unlink
        NONTERMINAL_NODE,
        56, // -> ipc-posix-sem*
        0,
        ipc_posix_sem_unlink_filters,
        ipc_posix_sem_unlink_modifiers
    },
    { // ipc-posix-sem-wait
        NONTERMINAL_NODE,
        56, // -> ipc-posix-sem*
        0,
        ipc_posix_sem_wait_filters,
        ipc_posix_sem_wait_modifiers
    },
    { // ipc-posix-shm*
        NONTERMINAL_NODE,
        54, // -> ipc-posix*
        0,
        ipc_posix_shm_all_filters,
        ipc_posix_shm_all_modifiers
    },
    { // ipc-posix-shm-read-data
        NONTERMINAL_NODE,
        62, // -> ipc-posix-shm*
        0,
        ipc_posix_shm_read_data_filters,
        ipc_posix_shm_read_data_modifiers
    },
    { // ipc-posix-shm-write*
        NONTERMINAL_NODE,
        62, // -> ipc-posix-shm*
        0,
        ipc_posix_shm_write_all_filters,
        ipc_posix_shm_write_all_modifiers
    },
    { // ipc-posix-shm-write-create
        NONTERMINAL_NODE,
        64, // -> ipc-posix-shm-write*
        0,
        ipc_posix_shm_write_create_filters,
    ...
    { // ipc-posix-shm-write-data
        ...
        64, // -> ipc-posix-shm-write*
        0,
        ipc_posix_shm_write_data_filters,
        ipc_posix_shm_write_data_modifiers
    },
    { // ipc-posix-shm-write-unlink
        NONTERMINAL_NODE,
        64, // -> ipc-posix-shm-write*
        0,
        ipc_posix_shm_write_unlink_filters,
    ...
    { // ipc-sysv*
        ...
        53, // -> ipc*
        0,
        ipc_sysv_all_filters,
        ipc_sysv_all_modifiers
    },
    { // ipc-sysv-msg
        NONTERMINAL_NODE,
        68, // -> ipc-sysv*
        0,
        ipc_sysv_msg_filters,
        ipc_sysv_msg_modifiers
    },
    { // ipc-sysv-sem
        NONTERMINAL_NODE,
        68, // -> ipc-sysv*
        0,
        ipc_sysv_sem_filters,
        ipc_sysv_sem_modifiers
    },
    { // ipc-sysv-shm
        NONTERMINAL_NODE,
        68, // -> ipc-sysv*
        0,
        ipc_sysv_shm_filters,
        ipc_sysv_shm_modifiers
    },
    { // job-creation
        TERMINAL_NODE,
        0, // -> default
        0,
        job_creation_filters,
        job_creation_modifiers
    },
    { // load-unsigned-code
        NONTERMINAL_NODE,
        0, // -> default
        0,
        load_unsigned_code_filters,
        load_unsigned_code_modifiers
    },
    { // lsopen
        NONTERMINAL_NODE,
        0, // -> default
    ...
    { // mach-cross-domain-lookup
        ...
        0, // -> default
        1,
        mach_cross_domain_lookup_filters,
        mach_cross_domain_lookup_modifiers
    },
    { // mach-host*
        NONTERMINAL_NODE,
        75, // -> mach*
        0,
        mach_host_all_filters,
        mach_host_all_modifiers
    },
    { // mach-host-exception-port-set
        NONTERMINAL_NODE,
        77, // -> mach-host*
        0,
        mach_host_exception_port_set_filters,
    ...
    { // mach-host-special-port-set
        ...
        77, // -> mach-host*
        0,
        mach_host_special_port_set_filters,
    ...
    { // mach-issue-extension
        ...
        75, // -> mach*
        0,
        mach_issue_extension_filters,
        mach_issue_extension_modifiers
    },
    { // mach-lookup
        NONTERMINAL_NODE,
        75, // -> mach*
        0,
        mach_lookup_filters,
        mach_lookup_modifiers
    },
    { // mach-priv*
        NONTERMINAL_NODE,
        75, // -> mach*
        0,
        mach_priv_all_filters,
        mach_priv_all_modifiers
    },
    { // mach-priv-host-port
        NONTERMINAL_NODE,
        82, // -> mach-priv*
        0,
        mach_priv_host_port_filters,
        mach_priv_host_port_modifiers
    },
    { // mach-priv-task-port
        NONTERMINAL_NODE,
        82, // -> mach-priv*
        0,
        mach_priv_task_port_filters,
        mach_priv_task_port_modifiers
    },
    { // mach-register
        NONTERMINAL_NODE,
        75, // -> mach*
        0,
        mach_register_filters,
        mach_register_modifiers
    },
    { // mach-task-name
        NONTERMINAL_NODE,
        75, // -> mach*
        0,
        mach_task_name_filters,
        mach_task_name_modifiers
    },
    { // network*
        NONTERMINAL_NODE,
        0, // -> default
        0,
        network_all_filters,
        network_all_modifiers
    },
    { // network-inbound
        NONTERMINAL_NODE,
        87, // -> network*
        0,
        network_inbound_filters,
        network_inbound_modifiers
    },
    { // network-bind
        NONTERMINAL_NODE,
        88, // -> network-inbound
        0,
        network_bind_filters,
        network_bind_modifiers
    },
    { // network-outbound
        NONTERMINAL_NODE,
        87, // -> network*
        0,
        network_outbound_filters,
        network_outbound_modifiers
    },
    { // nvram*
        TERMINAL_NODE,
        0, // -> default
    ...
    { // nvram-delete
        ...
        91, // -> nvram*
        0,
        nvram_delete_filters,
        nvram_delete_modifiers
    },
    { // nvram-get
        NONTERMINAL_NODE,
        91, // -> nvram*
    ...
    { // opendirectory-user-modify
        ...
        0, // -> default
        0,
        opendirectory_user_modify_filters,
        opendirectory_user_modify_modifiers
    },
    { // process*
        NONTERMINAL_NODE,
        0, // -> default
        0,
        process_all_filters,
        process_all_modifiers
    },
    { // process-codesigning-status*
        NONTERMINAL_NODE,
        96, // -> process*
        0,
        process_codesigning_status_all_filters,
        process_codesigning_status_all_modifiers
    },
    { // process-codesigning-status-set
        NONTERMINAL_NODE,
        97, // -> process-codesigning-status*
        0,
        process_codesigning_status_set_filters,
    ...
    { // process-codesigning-status-get
        ...
        97, // -> process-codesigning-status*
        0,
        process_codesigning_status_get_filters,
    ...
    { // process-exec*
        ...
        96, // -> process*
        0,
        process_exec_all_filters,
        process_exec_all_modifiers
    },
    { // process-exec-interpreter
        NONTERMINAL_NODE,
        100, // -> process-exec*
        0,
        process_exec_interpreter_filters,
        process_exec_interpreter_modifiers
    },
    { // process-fork
        NONTERMINAL_NODE,
        96, // -> process*
        0,
        process_fork_filters,
        process_fork_modifiers
    },
    { // process-info*
        TERMINAL_NODE,
        0, // -> default
        1,
        process_info_all_filters,
        process_info_all_modifiers
    },
    { // process-info-codesignature
        TERMINAL_NODE,
        0, // -> default
        1,
        process_info_codesignature_filters,
    ...
    { // process-info-dirtycontrol
        ...
        103, // -> process-info*
        0,
        process_info_dirtycontrol_filters,
        process_info_dirtycontrol_modifiers
    },
    { // process-info-listpids
        NONTERMINAL_NODE,
        103, // -> process-info*
        0,
        process_info_listpids_filters,
        process_info_listpids_modifiers
    },
    { // process-info-rusage
        NONTERMINAL_NODE,
        103, // -> process-info*
        0,
        process_info_rusage_filters,
        process_info_rusage_modifiers
    },
    { // process-info-pidinfo
        NONTERMINAL_NODE,
        103, // -> process-info*
        0,
        process_info_pidinfo_filters,
        process_info_pidinfo_modifiers
    },
    { // process-info-pidfdinfo
        NONTERMINAL_NODE,
        103, // -> process-info*
        0,
        process_info_pidfdinfo_filters,
        process_info_pidfdinfo_modifiers
    },
    { // process-info-pidfileportinfo
        NONTERMINAL_NODE,
        103, // -> process-info*
        0,
        process_info_pidfileportinfo_filters,
    ...
    { // process-info-setcontrol
        ...
        103, // -> process-info*
        0,
        process_info_setcontrol_filters,
        process_info_setcontrol_modifiers
    },
    { // pseudo-tty
        NONTERMINAL_NODE,
        0, // -> default
    ...
    { // socket-ioctl
        ...
        0, // -> default
        1,
        socket_ioctl_filters,
        socket_ioctl_modifiers
    },
    { // sysctl*
        NONTERMINAL_NODE,
        0, // -> default
    ...
    { // sysctl-read
        ...
        0,
        sysctl_read_filters,
        sysctl_read_modifiers
    },
    { // sysctl-write
        NONTERMINAL_NODE,
        115, // -> sysctl*
        0,
        sysctl_write_filters,
        sysctl_write_modifiers
    },
    { // system*
        NONTERMINAL_NODE,
        0, // -> default
    ...
    { // system-acct
        ...
        0,
        system_acct_filters,
        system_acct_modifiers
    },
    { // system-audit
        NONTERMINAL_NODE,
        118, // -> system*
        0,
        system_audit_filters,
        system_audit_modifiers
    },
    { // system-automount
        NONTERMINAL_NODE,
        118, // -> system*
        0,
        system_automount_filters,
        system_automount_modifiers
    },
    { // system-debug
        NONTERMINAL_NODE,
        118, // -> system*
        0,
        system_debug_filters,
        system_debug_modifiers
    },
    { // system-fsctl
        NONTERMINAL_NODE,
        118, // -> system*
        0,
        system_fsctl_filters,
        system_fsctl_modifiers
    },
    { // system-info
        NONTERMINAL_NODE,
        118, // -> system*
        0,
        system_info_filters,
        system_info_modifiers
    },
    { // system-kext*
        NONTERMINAL_NODE,
        118, // -> system*
        0,
        system_kext_all_filters,
        system_kext_all_modifiers
    },
    { // system-kext-load
        NONTERMINAL_NODE,
        125, // -> system-kext*
        0,
        system_kext_load_filters,
        system_kext_load_modifiers
    },
    { // system-kext-unload
        NONTERMINAL_NODE,
        125, // -> system-kext*
        0,
        system_kext_unload_filters,
        system_kext_unload_modifiers
    },
    { // system-kext-query
        NONTERMINAL_NODE,
        125, // -> system-kext*
        0,
        system_kext_query_filters,
        system_kext_query_modifiers
    },
    { // system-mac-label
        NONTERMINAL_NODE,
        118, // -> system*
        0,
        system_mac_label_filters,
        system_mac_label_modifiers
    },
    { // system-nfssvc
        NONTERMINAL_NODE,
        118, // -> system*
        0,
        system_nfssvc_filters,
        system_nfssvc_modifiers
    },
    { // system-package-check
        NONTERMINAL_NODE,
        118, // -> system*
        0,
        system_package_check_filters,
        system_package_check_modifiers
    },
    { // system-privilege
        TERMINAL_NODE,
        0, // -> default
        1,
        system_privilege_filters,
        system_privilege_modifiers
    },
    { // system-reboot
        NONTERMINAL_NODE,
        118, // -> system*
        0,
        system_reboot_filters,
        system_reboot_modifiers
    },
    { // system-sched
        NONTERMINAL_NODE,
        118, // -> system*
        0,
        system_sched_filters,
        system_sched_modifiers
    },
    { // system-set-time
        NONTERMINAL_NODE,
        118, // -> system*
        0,
        system_set_time_filters,
        system_set_time_modifiers
    },
    { // system-socket
        NONTERMINAL_NODE,
        118, // -> system*
        0,
        system_socket_filters,
        system_socket_modifiers
    },
    { // system-suspend-resume
        NONTERMINAL_NODE,
        118, // -> system*
        0,
        system_suspend_resume_filters,
        system_suspend_resume_modifiers
    },
    { // system-swap
        NONTERMINAL_NODE,
        118, // -> system*
        0,
        system_swap_filters,
        system_swap_modifiers
    },
    { // user-preference*
        NONTERMINAL_NODE,
        0, // -> default
        0,
        user_preference_all_filters,
        user_preference_all_modifiers
    },
    { // user-preference-read
        NONTERMINAL_NODE,
        139, // -> user-preference*
        0,
        user_preference_read_filters,
        user_preference_read_modifiers
    },
    { // managed-preference-read
        NONTERMINAL_NODE,
        140, // -> user-preference-read
        0,
        managed_preference_read_filters,
        managed_preference_read_modifiers
    },
    { // user-preference-write
        NONTERMINAL_NODE,
        139, // -> user-preference*
        0,
        user_preference_write_filters,
        user_preference_write_modifiers
    },
    { // syscall-unix
        TERMINAL_NODE,
        0, // -> default
        1,
        syscall_unix_filters,
        syscall_unix_modifiers
    },
    { // storage-class-map
        TERMINAL_NODE,
        0, // -> default
        0,
        storage_class_map_filters,
        storage_class_map_modifiers
    },
};

const size_t catalina_ops(const char ***names,
                          const operation_info_t **infos) {
