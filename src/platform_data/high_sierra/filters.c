...
static const named_argument process_attribute_args[] = {
    {"is-plugin", 0},           {"is-installer", 1},
    {"is-restricted", 2},       {"is-initproc", 3},
    {"is-platform-binary", 4},  {"is-sandboxed", 5},
    {"is-nvram-privileged", 6}, {NULL, 0}};
...
static const filter_info_t filter_infos[] = {
    {NULL, NULL, 0, 0, NULL},
    {"path", "path", SB_VALUE_TYPE_PATTERN_REGEX, FILTER_NO_REQUISITE, NULL},
    {"mount-relative-path", "path", SB_VALUE_TYPE_PATTERN_REGEX,
     FILTER_NO_REQUISITE, NULL},
    {"xattr", "xattr", SB_VALUE_TYPE_PATTERN_PREFIX, FILTER_NO_REQUISITE, NULL},
    {"file-mode", "file-mode", SB_VALUE_TYPE_BITFIELD, FILTER_NO_REQUISITE,
     NULL},
    {"ipc-posix-name", "posix-ipc", SB_VALUE_TYPE_PATTERN_PREFIX,
     FILTER_NO_REQUISITE, NULL},
    {"global-name", "mach", SB_VALUE_TYPE_PATTERN_PREFIX, FILTER_NO_REQUISITE,
     NULL},
    {"local-name", "mach", SB_VALUE_TYPE_PATTERN_PREFIX, FILTER_NO_REQUISITE,
     NULL},
    {
        "local",
        "network",
    ...
    {"control-name", "network", SB_VALUE_TYPE_PATTERN_PREFIX,
     FILTER_NO_REQUISITE, NULL},
    {
        "socket-domain",
        "socket",
    ...
    {"socket-protocol", "socket", SB_VALUE_TYPE_STRING, FILTER_NO_REQUISITE,
     NULL},
    {
        "target",
        "target",
    ...
    {"fsctl-command", "fsctl", SB_VALUE_TYPE_STRING, FILTER_NO_REQUISITE, NULL},
    {"ioctl-command", "ioctl", SB_VALUE_TYPE_STRING, FILTER_NO_REQUISITE, NULL},
    {"iokit-registry-entry-class", "iokit-registry-entry-class",
     SB_VALUE_TYPE_PATTERN_PREFIX, FILTER_NO_REQUISITE, NULL},
    {"iokit-property", "iokit-property", SB_VALUE_TYPE_PATTERN_PREFIX,
     FILTER_NO_REQUISITE, NULL},
    {"iokit-connection", "iokit-connection", SB_VALUE_TYPE_PATTERN_PREFIX,
     FILTER_NO_REQUISITE, NULL},
    {"device-major", "device", SB_VALUE_TYPE_STRING, FILTER_NO_REQUISITE, NULL},
    {"device-minor", "device", SB_VALUE_TYPE_STRING, FILTER_NO_REQUISITE, NULL},
    {"device-conforms-to", "device", SB_VALUE_TYPE_PATTERN_LITERAL,
     FILTER_NO_REQUISITE, NULL},
    {"extension", "extension", SB_VALUE_TYPE_PATTERN_LITERAL,
     FILTER_NO_REQUISITE, NULL},
    {"extension-class", "extension-class", SB_VALUE_TYPE_PATTERN_PREFIX,
     FILTER_NO_REQUISITE, NULL},
    {"appleevent-destination", "ae-destination", SB_VALUE_TYPE_PATTERN_SUBPATH,
     FILTER_NO_REQUISITE, NULL},
    {
        "system-attribute",
        "system",
    ...
    {"right-name", "auth-right-name", SB_VALUE_TYPE_PATTERN_PREFIX,
     FILTER_NO_REQUISITE, NULL},
    {"preference-domain", "preference-domain", SB_VALUE_TYPE_PATTERN_PREFIX,
     FILTER_NO_REQUISITE, NULL},
    {
        "vnode-type",
        "vnode-type",
    ...
    {"%entitlement-load", "entitlement", SB_VALUE_TYPE_PATTERN_LITERAL,
     FILTER_NO_REQUISITE, NULL},
    {"%entitlement-boolean", "entitlement", SB_VALUE_TYPE_BOOL, 30, NULL},
    {"%entitlement-string", "entitlement", SB_VALUE_TYPE_PATTERN_PREFIX, 30,
     NULL},
    {"kext-bundle-id", "kext-bundle-id", SB_VALUE_TYPE_PATTERN_PREFIX,
     FILTER_NO_REQUISITE, NULL},
    {"info-type", "info", SB_VALUE_TYPE_PATTERN_PREFIX, FILTER_NO_REQUISITE,
     NULL},
    {"notification-name", "notification", SB_VALUE_TYPE_PATTERN_PREFIX,
     FILTER_NO_REQUISITE, NULL},
    ...
    {"sysctl-name", "sysctl", SB_VALUE_TYPE_PATTERN_PREFIX, FILTER_NO_REQUISITE,
     NULL},
    {"process-path", "process", SB_VALUE_TYPE_PATTERN_REGEX,
     FILTER_NO_REQUISITE, NULL},
    ...
    {"rootless-proc-filter", "target", SB_VALUE_TYPE_BOOL, FILTER_NO_REQUISITE,
     NULL},
    {"privilege-id", "priv", SB_VALUE_TYPE_STRING, FILTER_NO_REQUISITE, NULL},
    {
        "process-attribute",
        "process",
        SB_VALUE_TYPE_INTEGER,
    ...
    {"uid", "process", SB_VALUE_TYPE_STRING, FILTER_NO_REQUISITE, NULL},
    {"nvram-variable", "nvram", SB_VALUE_TYPE_PATTERN_SUBPATH,
     FILTER_NO_REQUISITE, NULL},
    {
        "csr",
        "system",
    ...
    {"filesystem-name", "fs", SB_VALUE_TYPE_PATTERN_PREFIX, FILTER_NO_REQUISITE,
     NULL},
    {"boot-arg", "boot-arg", SB_VALUE_TYPE_PATTERN_PREFIX, FILTER_NO_REQUISITE,
     NULL},
    {"xpc-service-name", "mach", SB_VALUE_TYPE_PATTERN_PREFIX,
     FILTER_NO_REQUISITE, NULL},
    {"datavault-file-filter", "path", SB_VALUE_TYPE_BOOL, FILTER_NO_REQUISITE,
     NULL},
    {"signing-identifier", "process", SB_VALUE_TYPE_PATTERN_PREFIX,
     FILTER_NO_REQUISITE, NULL},
    {
        "signal-number",
        "signal",
    ...
    {"target-signing-identifier", "target", SB_VALUE_TYPE_PATTERN_PREFIX,
     FILTER_NO_REQUISITE, NULL},
    {"reboot-flags", "reboot-flags", SB_VALUE_TYPE_BITFIELD,
     FILTER_NO_REQUISITE, NULL},
    {"datavault-disk-filter", "path", SB_VALUE_TYPE_BOOL, FILTER_NO_REQUISITE,
     NULL},
    {"extension-path-ancestor", "extension", SB_VALUE_TYPE_BOOL,
     FILTER_NO_REQUISITE, NULL},
};
 ...
 */
static bool high_sierra_filter_accepts_type(const filter_info_t *const filter,
...
const size_t high_sierra_filters(const filter_info_t **infos,
                                 filter_accept_type_func *acceptor) {
  *infos = filter_infos;
  *acceptor = high_sierra_filter_accepts_type;
