...
; Stylistic changes to _init_scm as found in libsandbox.1.dylib. Most changes 
; are meant to improve readability and allow readers to see at a glance which
; changes were introduced by Apple. Such changes are marked with
; the beginning: ; <Apple> and the end  : ; </Apple>
;
; Original copyright notice: 
; Portions Copyright (c) 2012 Apple Inc.
...
; <Apple>: These are commented out, because they appear
;          to be semantically equivalent to the default operations
;          and using these saves us from re-implementing the internal
;          operation
